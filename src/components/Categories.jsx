...
const category = [
    ...
    return (
        <div
            ...
            <div
                className='flex justify-between items-center w-full px-4 py-2 my-4'>
            ...
            <div
                className='border-theme-dark w-full border'>
            </div> 

            <div
                className='flex gap-2 md:gap-4 items-center overflow-x-scroll w-full py-6 px-4 flex-nowrap'>
