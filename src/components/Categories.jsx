const Categories = () => {
  ...
  return (
    <div className="h-full">
      ...
      <div className="flex justify-between items-center w-full px-6 py-2 mt-4">
        <h1 className="text-white lg:text-3xl text-2xl font-heading-1 font-semibold">
          Shop by categories
        </h1>
      </div>
      ...
      <div className="flex gap-2 md:gap-4 items-center overflow-x-scroll w-full py-2 px-4 flex-nowrap">
          ...
          return (
            ...
            >
              <img
                ...
                alt="category"
              />
              <h2 className="text-center font-light text-sm">{items.title}</h2>
            </div>
          );
        })}
      </div>
