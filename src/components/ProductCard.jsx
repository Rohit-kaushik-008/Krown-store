const ProductCard = ({ products }) => {
  return (
    <div
    className="shadow-container rounded-xl bg-bg-dark shrink-0 justify-center items-center flex flex-col w-40 h-75 border-gray-800 hover:border-theme-dark border-2 hover:scale-105 transition-all duration-200 ease-in cursor-pointer mt-4">
      <img
