...
const Sidebar = ({openNav}) => {  
  ...
  return (
    ...
    <div
      className='h-screen bg-bg-main'>

      <div
        className='flex justify-between items-center border-2 border-theme-main bg-bg-dark rounded py-4 px-4'>


        <div
          className='flex justify-start items-center gap-2 font-heading-4 font-semibold'>
